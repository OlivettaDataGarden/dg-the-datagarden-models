...
class SocialEnvironmentV1(DataGardenModel):
	...
	local_facilities: LocalFacilities = Field(
		default_factory=LocalFacilities, description=L.LOCAL_FACILITIES
	)
	consumer_trust: ConsumerTrust = Field(
		default_factory=ConsumerTrust, description=L.CONSUMER_TRUST
	)
