...
class ConsumerTrustLegends:
	...
	BY_POPULATION_GROUP = (
		"Indicators of consumer trust by population group. "
		"Usually defined by national statistics agencies. "
		"Be careful to compare data from different countries."
	)
...
class ConsumerTrust(DataGardenSubModel):
	national_indicators: Optional[dict[str, float]] = Field(
		default=None, description=L.NATIONAL_INDICATORS
	)
