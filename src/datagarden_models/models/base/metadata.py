...
class MetadataModelLegends:
	...
	# DATA_IS_DERIVED = \
	# "data is derived by the datagarden from different sources and "
...
class MetadataModel(BaseModel):
	...
	# data_is_derived: bool = Field(
	#     default=False, description=DataGardenModelLegends.DATA_IS_DERIVED
	# )
