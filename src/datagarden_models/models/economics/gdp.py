...
class AddedValueByEconomicActivity(DataGardenSubModel):
	...
	value: dict[str, EconomicsValue] = Field(
		default_factory=dict, description=AVC.VALUE
	)
...
class GDP(DataGardenSubModel):
	...
	value_added: ValueAdded = Field(
		default_factory=ValueAdded, description=L.VALUE_ADDED
	)
