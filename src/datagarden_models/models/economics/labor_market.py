...
class LaborMarketStatusLegends:
	...
	EMPLOYED_RATE = (
		"Percentage of employed persons as percentage of working age "
		"population. (age 16-64)"
	)
	UNEMPLOYED = "Total number of unemployed persons."
	UNEMPLOYMENT_RATE = (
		"Percentage of unemployed persons actively seeking work as percentage "
		"of aged population above 16."
	)
	INACTIVE = "Total number of inactive persons."
	INACTIVE_RATE = (
		"Percentage of inactive persons as percentage of working age "
		"population. (age 16-64)"
	)
	CLAIM_UNEMPLOYMENT_BENEFIT = (
		"Total number of persons claiming unemployment benefits."
	)
	CLAIM_UNEMPLOYMENT_BENEFIT_RATE = (
		"Percentage of persons claiming unemployment benefits as percentage "
...
class LaborMarketStatus(DataGardenSubModel):
	...
	unemployment_rate: Optional[float] = Field(
		default=None, description=L.UNEMPLOYMENT_RATE
	)
