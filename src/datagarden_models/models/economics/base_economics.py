...
class EconomicBaseLegends:
	VALUE_CURRENT = (
		"value at current prices, ie exact price at the time of the data collection."
	)
	VALUE_CONSTANT = (
		"value at constant prices, ie value adjusted for inflation "
		"related to a reference year."
	)
