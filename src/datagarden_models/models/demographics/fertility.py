...
class FertilityV1Legends:
	...
	BIRTHS_BY_AGE = "Number of births categorized by age or age group of the mother."
	...
	FERTILITY_RATE_BY_AGE = (
		"Fertility rates categorized by age or age group of the mother."
	)
...
class Fertility(DataGardenSubModel):
	total_births: int | None = Field(default=None, description=L.TOTAL_BIRTHS)
	age_unknown: int | None = Field(default=None, description=L.AGE_UNKNOWN)
	births_by_age: AgeStatistics | None = Field(
		default=None, description=L.BIRTHS_BY_AGE
	)
	...
	fertility_rate_by_age: AgeStatistics | None = Field(
